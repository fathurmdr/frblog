...
export default function Sidebar({
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/admin">
          <div className="over mr-4 text-2xl font-semibold italic text-white">
            <span>FR Blog</span>
          </div>
        </Link>
        ...
        <button
          ...
          className="bg z-50 block text-white lg:hidden"
        >
          <svg
      ...
      <div
        ...
        className="flex flex-col overflow-y-hidden duration-300 ease-linear hover:overflow-y-auto"
      >
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-3 px-4 py-4 lg:mt-5 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
